import com.webhybird.module.label.entity.Demo;
import com.webhybird.module.label.entity.DemoBuilder;
...
public class Test {
    ...
    @org.junit.Test
    public void test(){
        Demo demo = new DemoBuilder().setParam(1).setParam2(3).setParam3(4).setParam4(5).setParam5(2).createDemo();
        Demo demo1 = new DemoBuilder().createDemo();
        demo1.setParam(0);
        demo1.setParam2(1);
        demo1.setParam3(2);
        demo1.setParam4(3);
