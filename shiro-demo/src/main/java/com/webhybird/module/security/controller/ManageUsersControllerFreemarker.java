 ...
 * under the License.
 */
package com.webhybird.module.security.controller;
 ...
 */
@Controller
public class ManageUsersControllerFreemarker extends FreemarkerBaseController {
    ...
    public String deleteUser(@RequestParam String userId) {
        Assert.isTrue(userId.equals("1"), "Cannot delete admin user");
